...
import com.audiolan.app.ui.settings.TransmitterSettingsScreen
...
fun AppNavGraph(
    ...
    NavHost(
        ...
        composable(Screen.Transmitter.route) {
            StreamListScreen(navController, serviceTypeName = ServiceType.TRANSMITTER.name)
        }
        ...
        composable(Screen.TransmitterSettings.route) {
            TransmitterSettingsScreen(navController)
        }
